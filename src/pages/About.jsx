...
const About = () => {
    return (
        <div className=''>
            <div className='sm:px-[100px] px-[40px] py-[40px] bg-[#f2f7fc] sm:h-[80vh] sm:flex sm:flex-row items-center sm:gap-6 flex flex-col gap-8'>
            ...
            <div className='bg-white sm:px-[100px] px-[40px] py-[40px] sm:grid sm:grid-cols-4 gap-6 flex flex-col'>
            ...
            <div className='sm:px-[100px] px-[40px] py-[40px] bg-[#f2f7fc] flex items-center flex-col gap-5'>
                <h1 className='font-bold sm:text-4xl text-2xl'>Our Mission</h1>
                <p className='text-gray-500 text-center sm:w-[68%] sm:text-normal text-sm'>To provide businesses with cutting-edge security solutions that protect their most valuable assets - their people, property, and data. We believe that every organization, regardless of size, deserves access to professional-grade security systems backed by expert support and reliable service.</p>
                <div className='sm:w-[70px] sm:h-[70px] w-[50px] h-[50px] flex items-center justify-center bg-linear-to-r from-blue-500 via-cyan-500 to-teal-500 rounded-full'>
                    <Shield color='white' />
                </div>
            </div>
            <div className="sm:px-[100px] px-[40px] bg-white py-[40px]">
                <div className="w-full flex flex-col items-center justify-center gap-2 mb-[20px]">
                    <h1 className="font-bold sm:text-4xl text-2xl">Our Values</h1>
                    <p className="sm:text-lg text-sm text-gray-500 text-centersm:w-[65%]">These core principles guide everything we do and ensure we deliver the highest quality security solutions.</p>
                </div>
            ...
            <div className='bg-[#f2f7fc] sm:px-[100px] px-[40px] py-[40px]'>
                <div className="w-full flex flex-col items-center justify-center gap-2 mb-[60px]">
                    <h1 className="font-bold sm:text-4xl text-2xl">Meet Our Team</h1>
                    <p className="sm:text-lg text-gray-500 text-center sm:w-[65%]">Our experienced professionals are dedicated to providing you with the best security solutions and support.</p>
                </div>
                <div className='w-full sm:h-[350px] h-[300px] rounded-lg mb-[40px]'>
            ...
            <div className='sm:px-[220px] px-[40px] py-[40px] bg-white flex flex-col items-center justify-center gap-6'>
                <h1 className='sm:text-4xl text-2xl font-bold'>Our Story</h1>
                <div className='flex flex-col gap-5 text-gray-500 text-justify sm:text-normal text-sm'>
